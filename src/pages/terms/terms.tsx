...
export const Terms = ({ contentView }: Props) => {
  const title = contentView === TermsContentView.terms ? 'Правила пользования' : 'Договор оферты';
      ...
      <article>
        ...
        <div className='sub-items-container'>
          ...
          <p>
            ...
            экономическую ситуацию, объявлены нарушающими общечеловеческие нормы этики и морали. 1.4. Но независимые
